  ...
  <!-- /.content-wrapper -->
	...
	<!-- EduAdmin App -->
	<script src="include/admin_style/js/template.js"></script>
	<script src="include/admin_style/js/pages/dashboard.js"></script>
	<script src="include/admin_style/js/pages/calendar.js"></script>
