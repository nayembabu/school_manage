...
<html lang="en">
  <head>
	...
	<!-- Vendors Style-->
	<link rel="stylesheet" href="include/admin_style/css/vendors_css.css">
  ...
  <header class="main-header">
	<div class="d-flex align-items-center logo-box justify-content-start">
		...
		<a href="index.html" class="logo">
		  <!-- logo-->
		  <div class="logo-lg">
			  <span class="light-logo"><img src="include/images/logo-dark-text.png" alt="logo"></span>
			  <span class="dark-logo"><img src="include/images/logo-light-text.png" alt="logo"></span>
		  </div>
		</a>	
	</div>  
    <!-- Header Navbar -->
