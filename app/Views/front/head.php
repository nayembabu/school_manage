...
<html lang="en">
  <head>
	...
	<!-- Vendors Style-->
	<link rel="stylesheet" href="include/front_style/css/vendors_css.css">
	  
	<!-- Style-->  
	<link rel="stylesheet" href="include/front_style/css/style.css">
	<link rel="stylesheet" href="include/front_style/css/skin_color.css">
		<!-- Vendor JS -->
		...
		<nav hidden class="nav-white nav-transparent">
			<div class="nav-header">
				<a href="index.html" class="brand">
					<img src="include/images/logo-light-text2.png" alt=""/>
				</a>
					...
					<div class="megamenu-content">
						<div class="row">
							...
							<div class="col-md-3 col-12 d-none d-lg-block">
								<img src="include/images/front-end-img/adv.jpg" class="img-fluid" alt="" />
							</div>
						</div>
					</div>
				</li>				
				...
				<li class="megamenu" data-width="270">
					...
					<div class="megamenu-content megamenu-cart">
						...
						<div class="cart-body">
							<ul>
								<li>
									<img src="include/images/front-end-img/product/product-1.png" alt="">
								...
								<li>
									<img src="include/images/front-end-img/product/product-2.png" alt="">
									<h5 class="title">Lorem ipsum dolor</h5>
									<span class="qty">Quantity: 02</span>
									<span class="price-st">$843,12</span>
									<a href="#" class="link"></a>
								...
								<li>
									<img src="include/images/front-end-img/product/product-3.png" alt="">
									<h5 class="title">Lorem ipsum dolor</h5>
									<span class="qty">Quantity: 02</span>
									<span class="price-st">$843,12</span>
									<a href="#" class="link"></a>
