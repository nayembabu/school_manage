...
<footer class="footer_three">
					...
					<div class="col-12 col-lg-3">
                        <div class="widget widget_gallery clearfix">
                            ...
                            <ul class="list-unstyled">
								<li><img src="include/images/gallery/thumb/1.jpg" alt=""></li>
								<li><img src="include/images/gallery/thumb/2.jpg" alt=""></li>
								<li><img src="include/images/gallery/thumb/3.jpg" alt=""></li>
								<li><img src="include/images/gallery/thumb/4.jpg" alt=""></li>
								<li><img src="include/images/gallery/thumb/5.jpg" alt=""></li>
								<li><img src="include/images/gallery/thumb/6.jpg" alt=""></li>
								<li><img src="include/images/gallery/thumb/7.jpg" alt=""></li>
								<li><img src="include/images/gallery/thumb/8.jpg" alt=""></li>
								<li><img src="include/images/gallery/thumb/9.jpg" alt=""></li>
								<li><img src="include/images/gallery/thumb/10.jpg" alt=""></li>
								<li><img src="include/images/gallery/thumb/11.jpg" alt=""></li>
								<li><img src="include/images/gallery/thumb/12.jpg" alt=""></li>
							</ul>
                        </div>
                    </div>
					<div class="col-lg-3 col-12">
	...
	<!-- Vendor JS -->
	<script src="include/front_style/js/vendors.min.js"></script>	
	<!-- Corenav Master JavaScript -->
    <script src="include/front_style/corenav-master/coreNavigation-1.1.3.js"></script>
    <script src="include/front_style/js/nav.js"></script>
	<script src="include/assets/vendor_components/OwlCarousel2/dist/owl.carousel.js"></script>
	<script src="include/assets/vendor_components/bootstrap-select/dist/js/bootstrap-select.js"></script>
	
	
	<!-- EduAdmin front end -->
	<script src="include/front_style/js/template.js"></script>
