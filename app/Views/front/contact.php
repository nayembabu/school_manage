            ...
            <div class="col-md-7 col-12">
                <form class="contact-form" action="<?= base_url('contact/submit') ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="tel" class="form-control" placeholder="Phone" value="<?= old('phone') ?>"
                                    name="phone" required>
                            </div>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="col-md-5 col-12 mt-30 mt-md-0">
                <div class="box box-body p-40 bg-dark mb-0">
                    ...
                    <ul class="list-unstyled d-flex gap-items-1">
                        <li><a href="#" class="waves-effect waves-circle btn btn-social-icon btn-circle btn-facebook"><i
                                    class="fa fa-facebook"></i></a></li>
                        <li><a href="#" class="waves-effect waves-circle btn btn-social-icon btn-circle btn-twitter"><i
                                    class="fa fa-twitter"></i></a></li>
                        <li><a href="#" class="waves-effect waves-circle btn btn-social-icon btn-circle btn-linkedin"><i
                                    class="fa fa-linkedin"></i></a></li>
                        <li><a href="#" class="waves-effect waves-circle btn btn-social-icon btn-circle btn-youtube"><i
